    ...
    def run(self):
        ...
        while not stop_flag:
            ...
            try:
                ...
                logging.warning('udp_listen has not been called')
    ...
    def sendto(self, data, addr):
        ...
        try:
            try:
                ...
                logging.critical('Sending data to %r\n%r' % (addr,
                                                             data))
                logging.exception('See critical log above')
        finally:
            self._lock.release()
