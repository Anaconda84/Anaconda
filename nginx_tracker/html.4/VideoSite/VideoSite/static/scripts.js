  ...
  function init(url, torrent)
  {
    ...
    if(os == 'Windows' && (browser == 'Chrome' || browser == 'Firefox' || browser == 'Opera') )
    {
  ...
  function error()
  {
    ...
    //cookie_date.setTime ( cookie_date.getTime() + 300 );
    expires.setTime(expires.getTime() + 300);
    setCookie("req", "answer", expires);
    alert('Set Cookie !!!!');
  }
